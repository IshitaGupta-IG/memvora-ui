...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen">
      <Navbar />
      <main className="mx-auto max-w-7xl px-3 pb-28 pt-4 sm:px-4 sm:py-8 lg:px-6">
        <section className="mb-5 overflow-hidden rounded-3xl border border-white/80 bg-slate-950 p-4 text-white shadow-glow sm:mb-8 sm:p-8">
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <div className="max-w-3xl">
              <p className="mb-3 text-sm font-semibold uppercase text-brand-200">Semantic memory workspace</p>
              <h1 className="text-2xl font-black text-white sm:text-4xl">Capture anything. Retrieve it like a thought.</h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
                Upload notes, files, and links, then ask AI Chat to search, summarize, and connect your saved context.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-2 text-center sm:gap-3">
              <div className="rounded-2xl border border-white/10 bg-white/10 px-3 py-3 sm:px-4">
          ...
          <section className="space-y-6">
            ...
            <section className="soft-panel p-4 sm:p-6">
              <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button className="button-secondary w-full shrink-0 sm:w-auto" onClick={summarizeThoughts} disabled={summaryLoading}>
                  <Sparkles size={17} />
            ...
            <section id="memories" className="soft-panel scroll-mt-20 p-3 sm:scroll-mt-24 sm:p-6">
